#' @title Converts standard delta notation to isotopic ratio
#'
#' @description This function is used to convert isotope data in standard delta notation into isotopic ratio (R).
...
#'
#' @usage delta.to.R(x, isotope.system=NULL, reference.std = NULL)
#'
#' @param x Numeric.
#'
