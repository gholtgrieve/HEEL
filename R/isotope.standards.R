#'@title Data set containing isotope standards and their accepted values
#'
#'@description Dataframe containing information on isotope reference materials organized as a
