...
EA.check <- function(results){
  ...
  known.standard.values <- data.frame(group = c("GA1", "GA2", "SALMON"),
                             ...
                             mass.percent.C = c(40.8168, 40.8168, 45.7),
                             mass.percent.N = c(9.52, 9.52, 11.83))
  ...
  error.analysis.results$Accuracy[error.analysis.results$Value == "mass.percent.C"] <- mean.salmon.pctC.measured - known.standard.values[3, "mass.percent.C"]
  ...
  error.analysis.results$Accuracy[error.analysis.results$Value == "mass.percent.N"] <- mean.GA1.pctN.measured - known.standard.values[1, "mass.percent.N"]
