...
# ZEROS & BLANKS
  ...
  contains the data for blanks and zero from this run. No tbale incated balnks and zeros were not measurable. Blank correction has
  not been implimented in the script. 
```{r echo=FALSE}
#knitr::kable(standard.coefficients, format = "simple", caption="Blank & Zero data.")   
